...
@register(Tags.security, deploy=True)
def check_secret_key_fallbacks(app_configs, **kwargs): # -> list[Any]:
    ...
...
@register(Tags.security, deploy=True)
def check_referrer_policy(app_configs, **kwargs): # -> list[Warning] | list[Error] | list[Any]:
    ...

@register(Tags.security, deploy=True)
def check_cross_origin_opener_policy(app_configs, **kwargs): # -> list[Error] | list[Any]:
    ...
