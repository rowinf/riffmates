...
def gettext(message): # -> _Wrapped[Callable[..., Any], object, Callable[..., Any], Any] | SafeString | Any:
    """
...
def pgettext(context, message): # -> _Wrapped[Callable[..., Any], object, Callable[..., Any], Any] | SafeString | Any | str:
    ...
