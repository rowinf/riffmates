...
def check_errors(fn): # -> _Wrapped[Callable[..., Any], Any, Callable[..., Any], None]:
    ...
...
def iter_all_python_module_files(): # -> frozenset[Any]:
    ...

@lru_cache(maxsize=1)
def iter_modules_and_files(modules, extra_files): # -> frozenset[Any]:
    """Iterate through all modules needed to be watched."""
    ...

@lru_cache(maxsize=1)
def common_roots(paths): # -> tuple[Any | Path, ...]:
    """
...
def sys_path_directories(): # -> Generator[Path, Any, None]:
    """
...
def get_child_arguments(): # -> list[Any] | list[str]:
    """
...
class BaseReloader:
    ...
    def watched_files(self, include_globs=...): # -> Generator[Any, Any, None]:
        """
...
class StatReloader(BaseReloader):
    SLEEP_TIME = ...
    def tick(self): # -> Generator[None, Any, NoReturn]:
        ...
    
    def snapshot_files(self): # -> Generator[tuple[Any, Any], Any, None]:
        ...
...
class WatchmanReloader(BaseReloader):
    ...
    def watched_roots(self, watched_files): # -> frozenset[Any | Path]:
        ...
