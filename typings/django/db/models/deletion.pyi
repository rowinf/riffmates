...
def get_candidate_relations_to_delete(opts): # -> Generator[Any, None, None]:
    ...
...
class Collector:
    ...
    def add(self, objs, source=..., nullable=..., reverse_dependency=...): # -> list[Any]:
        """
    ...
    def get_del_batches(self, objs, fields): # -> list[Any]:
        """
    ...
    def instances_with_model(self): # -> Generator[tuple[Any, Any], Any, None]:
        ...
    
    def sort(self): # -> None:
        ...
    
    def delete(self): # -> tuple[Any | int, dict[Any, Any | int]] | tuple[int, dict[Any, int]]:
        ...
