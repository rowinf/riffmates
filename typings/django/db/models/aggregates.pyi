...
class Aggregate(Func):
    ...
    def resolve_expression(self, query=..., allow_joins=..., reuse=..., summarize=..., for_save=...): # -> Self | Coalesce:
        ...
    ...
    def as_sql(self, compiler, connection, **extra_context): # -> tuple[Any, tuple[Any, ...]] | tuple[Any, list[Any]]:
        ...
