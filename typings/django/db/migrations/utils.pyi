...
def resolve_relation(model, app_label=..., model_name=...): # -> tuple[Any, Any] | tuple[str, str] | tuple[Any, str]:
    """
...
def get_references(state, model_tuple, field_tuple=...): # -> Generator[tuple[Any, Any, Any, FieldReference], Any, None]:
    """
