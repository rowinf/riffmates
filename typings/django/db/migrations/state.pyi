...
def get_related_models_tuples(model): # -> set[tuple[Any, Any]]:
    """
...
def get_related_models_recursive(model): # -> set[Any]:
    """
...
class ProjectState:
    ...
    @property
    def relations(self): # -> defaultdict[Any, defaultdict[Any, Any]] | None:
        ...
...
class StateApps(Apps):
    ...
    @contextmanager
    def bulk_update(self): # -> Generator[None, Any, None]:
        ...
...
class ModelState:
    ...
    @classmethod
    def from_model(cls, model, exclude_rels=...): # -> Self:
        """Given a model, return a ModelState representing it."""
        ...
    
    def construct_managers(self): # -> Generator[tuple[Any, Any], Any, None]:
