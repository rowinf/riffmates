...
@contextmanager
def mark_for_rollback_on_error(using=...): # -> Generator[None, Any, None]:
    """
...
def atomic(using=..., savepoint=..., durable=...): # -> Callable[..., object] | Atomic:
    ...

def non_atomic_requests(using=...): # -> Callable[..., object] | Callable[..., Any]:
    ...
