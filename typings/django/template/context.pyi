...
class Context(BaseContext):
    ...
    @contextmanager
    def bind_template(self, template): # -> Generator[None, Any, None]:
        ...
...
class RenderContext(BaseContext):
    ...
    @contextmanager
    def push_state(self, template, isolated_context=...): # -> Generator[None, Any, None]:
        ...
