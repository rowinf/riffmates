...
class Template:
    ...
    def get_exception_info(self, exception, token): # -> dict[str, Any]:
        """
...
def linebreak_iter(template_source): # -> Generator[Any | int, Any, None]:
    ...
...
class Token:
    ...
    def split_contents(self): # -> list[Any]:
        ...
...
class FilterExpression:
    ...
    def resolve(self, context, ignore_failures=...): # -> __proxy__ | float | int | _Wrapped[Callable[..., Any], object, Callable[..., Any], Any] | SafeString | Variable | None:
        ...
...
class Variable:
    ...
    def resolve(self, context): # -> __proxy__ | float | int | _Wrapped[Callable[..., Any], object, Callable[..., Any], Any] | SafeString | None:
...
class Node:
    ...
    def get_nodes_by_type(self, nodetype): # -> list[Any]:
        """
...
kwarg_re = ...
def token_kwargs(bits, parser, support_legacy=...): # -> dict[Any, Any]:
    """
