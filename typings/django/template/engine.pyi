...
class Engine:
    ...
    def get_template_libraries(self, libraries): # -> dict[Any, Any]:
        ...
    
    @cached_property
    def template_loaders(self): # -> list[Any]:
        ...
    
    def get_template_loaders(self, template_loaders): # -> list[Any]:
        ...
    
    def find_template_loader(self, loader): # -> Any:
        ...
    
    def find_template(self, name, dirs=..., skip=...): # -> tuple[Any, Any]:
        ...
